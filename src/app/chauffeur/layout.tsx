...
import { LayoutDashboard, PlusCircle, Coins, CalendarCheck, FileSearch, User, HelpCircle, Route, ClipboardList } from "lucide-react";
...
const nav = [
  ...
  { href: "/chauffeur/missions", label: "Mes missions", icon: ClipboardList },
...
const mobileNav = [
  ...
  { href: "/chauffeur/missions", label: "Missions", icon: ClipboardList },
